...
main: 
	...
	# Persistência dos valores nos registradores $sx da notas em centavos 
	...
	mul $s5, $s5, 50 # Transformação do valor em centavos
	
	li $s6, 1 #Quantidade de notas de R$0,25 inseridas.
	mul $s6, $s6, 25 # Transformação do valor em centavos
	
	li $s7, 1 #Quantidade de notas de R$0,10 inseridas.
	mul $s7, $s7, 10 # Transformação do valor em centavos
